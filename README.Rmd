...
params: 
  main_repo: "202111-xgboost"
  turma: "202111-xgboost"
  nome_curso: "XGBoost"
  num_aula: 1
...
knitr::kable(
  tibble::tibble(
    slide = list.files("slides/", "\\.(html)|(pdf)"),
...
- [XGBoost - Documentação oficial](https://xgboost.readthedocs.io/en/latest/tutorials/model.html)
